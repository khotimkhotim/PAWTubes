...
$data = mysql_query("SELECT * FROM siswa_aktif_magang ORDER BY nisn")
...
<html lang="en">
<h2><center>Data Siswa Aktif PKL</h2></center>
                ...
                <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
                    <thead>
                        <tr class="info">
                                        ...
                                        <th width="150"><center>Program Keahlian</center></th>
                                        <th width="320"><center>Awal PKL</center></th>            
                                        <th width="110"><center>Selesai PKL</center></th>
				            ...
				            while ($siswa = mysql_fetch_assoc($data)){
                                extract($siswa);
                                            ...
                                            echo "<td><center>$siswa[awal_bulan_pkl]</center></td>";
                                            echo "<td><center>$siswa[selesai_bulan_pkl]</center></td>";
										echo "<td>
											<p> <a href='dashboard-admin.php?page=hapus_siswa_aktif&nisn=$siswa[nisn]'><span data-placement='top' data-toggle='tooltip' title='Hapus'><button class='btn btn-danger btn-xs' data-title='Hapus' data-toggle='modal' data-target='#myModal' ><span class='glyphicon glyphicon-trash'></span></button></a>       
										</td>
                                    </tr>
                                       "
                                                ?>
