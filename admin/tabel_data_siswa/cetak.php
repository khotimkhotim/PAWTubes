...
$kode = $_GET['nisn'];
$query = mysql_query("SELECT * FROM data_siswa_pkl WHERE nisn = '$kode'");
$lihat1 = mysql_fetch_array($query);
?>
<html>
<head>
...
<body onload="print();">
	<div class="row">
		<div class="col-md-9 col-md-offset-1">
			<div class="panel">
				<div class="panel-heading"><h2><center>Bukti Registrasi Program Kerja Lapangan</center></h2></div>
						<fieldset>                             
